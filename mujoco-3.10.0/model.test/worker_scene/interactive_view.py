...
XML_CANDIDATES = (
    os.path.join(os.path.dirname(os.path.abspath(__file__)), "scene_with_robot.xml"),
    os.path.join(os.path.dirname(os.path.abspath(__file__)), "scene_with_robot_py38.xml"),
)
